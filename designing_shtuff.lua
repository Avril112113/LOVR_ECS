...
print("default:", pointer.x, pointer.y, pointer.z, pointer.test)

pointer.x = 1
pointer.y = 2
pointer.z = 55
pointer.test = "Testing strings"
print("changed fields:", pointer.x, pointer.y, pointer.z, pointer.test)

local pointer2 = Common.CreateComponentPtr(Common.TestComponentDef, componentBlob)
---@diagnostic disable-next-line: undefined-field
print("different pointer:", pointer2.x, pointer2.y, pointer2.z, pointer2.test)
